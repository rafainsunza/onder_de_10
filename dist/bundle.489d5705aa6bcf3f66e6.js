...
var DtPlayerNameInput = /*#__PURE__*/function (_HTMLElement) {
  function DtPlayerNameInput() {
    ...
    document.addEventListener('step-back', function (e) {
      return _this.handleBackClick(e);
    });
    return _this;
  }
...
.slide-out {
  animation: slide-out 0.5s ease-in forwards;
}`, "",{"version":3,"sources":["webpack://./src/javascript/custom-components/player-name-input/dt-player-name-input.component.sass","webpack://./src/styles/_variables.sass"],"names":[],"mappings":"AAEA;EACI,sCCqCW;EDpCX,UAAA;EACA,SAAA;EACA,gBAAA;EACA,sBAAA;EACA,YAAA;AADJ;;AAGA;EACI,YAAA;EACA,YAAA;EACA,mBC4BmB;ED3BnB,mBAAA;EACA,eAAA;EACA,mCAAA;EACA,oCCbQ;EDcR,eAAA;EACA,sBCbI;EDcJ,kBAAA;EACA,8BCZG;ADYP;AAEI;EAbJ;IAcQ,eCXO;EDYb;AACF;AAAI;EACI,aAAA;AAER;AADI;EACI,YAAA;EACA,gBCXY;ADcpB;AADI;EACI,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,UAAA;EACA,sBC/BA;ADkCR;AADI;EACI,eAAA;EACA,gBCpBU;EDqBV,kBAAA;EACA,mBChBK;ADmBb;AADQ;EANJ;IAOQ,eCjCG;EDqCb;AACF;AAHI;EACI,YAAA;EACA,mBCTe;EDUf,YAAA;EACA,eCxCO;EDyCP,gBAAA;EACA,sBChDA;EDiDA,mCC9CD;ED+CC,kBAAA;AAKR;AAHQ;EACI,8CCCK;ADIjB;AAHQ;EACI,eAAA;AAKZ;;AAHA;EACI,kBAAA;EACA,YAAA;EACA,aAAA;EACA,sBAAA;AAMJ;;AAJA;EACI,oCAAA;AAOJ;AALI;EACI,kBAAA;EACA,QAAA;EACA,UAAA;EACA,sBCrEM;EDsEN,YAAA;AAOR;;AALA;EACI,aAAA;AAQJ;;AAJA;EACI;IACI,UAAA;IACA,wBAAA;EAON;AACF;AANA;EACI;IACI,UAAA;IACA,wBAAA;EAQN;EANE;IACI,UAAA;IACA,2BAAA;EAQN;AACF;AAPA;EACI,UAAA;EACA,4BAAA;EACA,2CAAA;AASJ;;AAPA;EACI,0CAAA;AAUJ","sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___.toString());
...
/* harmony import */ var _javascript_custom_components_player_name_input_dt_player_name_input_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./javascript/custom-components/player-name-input/dt-player-name-input.js */ "./src/javascript/custom-components/player-name-input/dt-player-name-input.js");
/* harmony import */ var _javascript_modules_utils_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./javascript/modules/utils.js */ "./src/javascript/modules/utils.js");
/* harmony import */ var _javascript_modules_languages_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./javascript/modules/languages.js */ "./src/javascript/modules/languages.js");
...
(0,_javascript_modules_utils_js__WEBPACK_IMPORTED_MODULE_5__.fetchImage)('assets/onder_de_10_logo.png', document.querySelector('.logo-link'), 'logo-footer');
document.addEventListener('language-changed', function (e) {
  (0,_javascript_modules_languages_js__WEBPACK_IMPORTED_MODULE_6__.translate)(e.detail.title, document.querySelector('.header-title'));
});
})();

/******/ })()
;
//# sourceMappingURL=bundle.489d5705aa6bcf3f66e6.js.map